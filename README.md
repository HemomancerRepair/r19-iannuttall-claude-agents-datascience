        ...
        > **Adaptation of `iannuttall/claude-agents` for Data Science & AI/ML use cases.**
        ...
        **5 multi-step workflows**, all with a consistent
        ...
        ```bash
        # Clone this skill
        cp -r . ~/.claude/skills/r00-iannuttall-claude-agents--datascience/

        # Register in Claude Code
        # In a Claude Code session:
        /read ~/.claude/skills/r00-iannuttall-claude-agents--datascience/SKILL.md
        ```
